...
// Handler für Square-Shape
  ...
  this.handlers = {
    ...
    // Handler für Process-Shape, Bezug auf die Funktion: drawProcess, Versuch das ganze über einen path darzustellen 

    'postit:ProcessPostit': function(parentGfx, element) {
      ...
      var path = drawProcess(parentGfx, element.width, element.height, 0, attrs);
