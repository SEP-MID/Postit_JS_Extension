...
// 3. Funktion: Pfad malen, d = Pfad --> M 2 3 L 10 3 L 13 6 L 10 9 L 2 9 L 2 3
  ...
  function drawPath(parentGfx, d, offset, attrs) {
    ...
    svgAttr(path,{ d: d }); // Wie wird "d" übergeben?
    svgAttr(path, attrs);
...
// Handler für Square-Shape
  ...
  this.handlers = {
    ...
    'postit:PathPostit': function(parentGfx, element) {
      ...
      const d = "M 4 1 L 37 1 L 97 1 L 133 63 L 103 127 L 4 127 Z";  //Pfad eingeben
      var rect = drawPath(parentGfx, d, attrs);
