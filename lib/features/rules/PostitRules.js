...
function canDrop(element, target) {
  ...
  if (is(element, 'postit:HappyEmotionPostit') && is(target, 'postit:SquarePostit')) {
    return true;
  }

  // Neue neutrale Emotion
  if (is(element, 'postit:NeutralEmotionPostit') && is(target, 'postit:SquarePostit')) {
    return true;
  }

  // Neue negative Emotion
  if (is(element, 'postit:SadEmotionPostit') && is(target, 'postit:SquarePostit')) {
    return true;
  }

  // Neuen Moment of truth
  if (is(element, 'postit:TruthPostit') && is(target, 'postit:SquarePostit')) {
    return true;
  }
  ...
  if (is(element, 'postit:Image') && is(target, 'postit:PostitBoard')) {
    return true;
  }
  ...
  if (is(element, 'postit:TextBox') && is(target, 'postit:PostitBoard')) {
    return true;
  }
  ...
  if (is(element, 'postit:TextBox') && is(target, 'postit:SquarePostit')) {
    return true;
  }
