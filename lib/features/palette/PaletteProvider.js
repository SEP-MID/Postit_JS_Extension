...
//Erstellen der neuen SVG Shape --> Process; to-do: Anpassen des 1. Parameter (Type): Path: M 2 3 L 10 3 L 13 6 L 10 9 L 2 9 L 2 3

'create.process-postit': createAction(
  'postit:SquarePostit', 'postits', 'pjs-postit-process',
  translate('Customer Journey Layout erzeugen'), { color: COLORS.BLACK }
),


// Erstellen der Kreisform 
